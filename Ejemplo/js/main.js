...
function creaNuevaDB(tx){
	...
	tx.executeSql("INSERT INTO agenda_curso (id,nombre,telefono,email,domicilio,categoria,nota) VALUES (1,'Rin Rin','+6699900970','m.olivarria@ccumazatlan.mx','islote #100 inf playas','familia','pin pon es un muñeco')");
}
...
function queryDBInsertForm(tx){
	...
	tx.executeSql("INSERT INTO agenda_curso (nombre,telefono,email,domicilio,categorial,nota) VALUES ('"+$("#ti_nombre").val()+"','"+$("#ti_telefono").val()+"','"+$("#ti_mail").val()+"','"+$("#ti_domicilio").val()+"','"+cat+"','"+$.imageURL+"','"+$("#ti_nota").val()+"')", [], newFormSuccess, errorDB);
}
